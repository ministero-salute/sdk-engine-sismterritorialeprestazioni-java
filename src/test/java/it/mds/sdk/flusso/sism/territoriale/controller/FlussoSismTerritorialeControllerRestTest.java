...
class FlussoSismTerritorialeControllerRestTest {

    @InjectMocks
    @Spy
    private FlussoSismTerritorialeControllerRest controller;
    ...
    @Mock
    private FlussoSismTerrService service;
    private ConfigurazioneFlussoSismTerritoriale.Rules rules = mock(ConfigurazioneFlussoSismTerritoriale.Rules.class);

    private ConfigurazioneFlussoSismTerritoriale.Flusso flusso = mock(ConfigurazioneFlussoSismTerritoriale.Flusso.class);
    ...
    private ConfigurazioneFlussoSismTerritoriale.NomeFlusso nomeFlusso = Mockito.mock(ConfigurazioneFlussoSismTerritoriale.NomeFlusso.class);
